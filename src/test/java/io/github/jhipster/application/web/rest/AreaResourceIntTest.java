...
public class AreaResourceIntTest {
    ...
    private static final Long DEFAULT_IDAREA = 1L;
    private static final Long UPDATED_IDAREA = 2L;
    ...
    public void createArea() throws Exception {
        ...
        assertThat(testArea.getIdarea()).isEqualTo(DEFAULT_IDAREA);
    ...
    public void getAllAreas() throws Exception {
        ...
        restAreaMockMvc.perform(get("/api/areas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].idarea").value(hasItem(DEFAULT_IDAREA.intValue())))
    ...
    public void getArea() throws Exception {
        ...
        restAreaMockMvc.perform(get("/api/areas/{id}", area.getId()))
            ...
            .andExpect(jsonPath("$.idarea").value(DEFAULT_IDAREA.intValue()))
    ...
    public void updateArea() throws Exception {
        ...
        Area testArea = areaList.get(areaList.size() - 1);
        assertThat(testArea.getIdarea()).isEqualTo(UPDATED_IDAREA);
