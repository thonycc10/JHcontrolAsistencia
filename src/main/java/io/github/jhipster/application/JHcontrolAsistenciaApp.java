...
public class JHcontrolAsistenciaApp {

    private static final Logger log = LoggerFactory.getLogger(JHcontrolAsistenciaApp.class);

    private final Environment env;

    public JHcontrolAsistenciaApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JHcontrolAsistencia.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JHcontrolAsistenciaApp.class);
